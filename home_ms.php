<?php
/**
 * DanaHibah™ - Official Bahasa Melayu Landing Page (Elite Edition with Flawless Continuous Curve & Custom Logo)
...
<head>
    ...
    <meta name="description" content="DanaHibah™ membantu masjid dan surau mengurus kutipan derma dengan lebih telus, selamat dan mudah melalui gabungan perkakasan pintar dan platform digital bersepadu.">
    <meta name="keywords" content="DanaHibah, tadbir urus digital, kutipan derma masjid, surau, peranti derma selamat, Malaysia, reka bentuk masjid elit">
    <title>DanaHibah™ — Sistem Tadbir Urus & Kutipan Derma untuk Masjid & Surau</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-glass fixed-top py-3">
        <div class="container">
            <a class="navbar-brand" href="home_ms.php">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item"><a class="nav-link active" href="#hero">Utama</a></li>
                    <li class="nav-item"><a class="nav-link" href="#why">Kenapa DanaHibah</a></li>
                    <li class="nav-item"><a class="nav-link" href="#how">Cara Berfungsi</a></li>
                    <li class="nav-item"><a class="nav-link" href="#solutions">Penyelesaian Kami</a></li>
                    <li class="nav-item"><a class="nav-link" href="#features">Ciri & Kebaikan</a></li>
                </ul>
                <div class="d-flex align-items-center gap-3 mt-3 mt-lg-0">
                    <!-- Language Switcher -->
                    <div class="lang-switch">
                        <a href="home.php" class="lang-btn">EN</a>
                        <a href="home_ms.php" class="lang-btn active">BM</a>
                    </div>
                    <!-- Login Button Top Right -->
                    <a href="login.php" class="btn btn-login">
                        <i class="bi bi-person-circle me-2"></i>Log Masuk
                    </a>
                </div>
            </div>
        </div>
    ...
    <section class="hero-section-custom" id="hero">
        ...
        <div class="container position-relative z-3 py-5">
            <div class="row g-0 align-items-stretch" style="min-height: 780px;">
                <!-- Left Column: Content & Kenapa DanaHibah -->
                <div class="col-lg-6 d-flex flex-column justify-content-between pe-lg-5 py-4">
                    <div class="hero-content-top mb-5 pe-lg-4 my-auto">
                        ...
                        <h4 class="hero-subheading">Sistem Tadbir Urus & Kutipan Derma Masjid & Surau</h4>
                        <h1 class="hero-title-main mb-4">MODEN. SELAMAT. AMANAH.</h1>
                        <p class="hero-desc-main mb-5">Memperkasa masjid dengan perkakasan pintar kalis gangguan dan platform tadbir urus awan yang telus serta bersepadu.</p>
                        <div class="d-flex flex-wrap gap-3 mb-4">
                            <a href="#how" class="btn btn-login py-3 px-5 fs-5">Mula Sekarang</a>
                            <a href="#contact" class="btn btn-outline-dark py-3 px-4 fs-5" style="border-radius:30px;font-weight:700;border-width:2px;">Hubungi Sokongan</a>
                        </div>
                    </div>
                    ...
                    <div class="text-white pt-5 pe-lg-4 mt-auto">
                        <h3 class="kenapa-title">KENAPA DANAHIBAH?</h3>
                        <div class="row g-5">
                            <div class="col-md-6">
                                <div class="d-flex align-items-start gap-4">
                                    <div class="kenapa-icon"><i class="bi bi-shield-check"></i></div>
                                    <div>
                                        <h5 class="fw-bold mb-1 text-gold">SELAMAT</h5>
                                        <p class="mb-0 fs-7 text-light">Perkakasan tahan gangguan dengan pemantauan masa nyata.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex align-items-start gap-4">
                                    ...
                                    <div>
                                        <h5 class="fw-bold mb-1 text-gold">TELUS</h5>
                                        <p class="mb-0 fs-7 text-light">Laporan kutipan jelas dan boleh dipantau bila-bila masa.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex align-items-start gap-4">
                                    ...
                                    <div>
                                        <h5 class="fw-bold mb-1 text-gold">AKAUNTABEL</h5>
                                        <p class="mb-0 fs-7 text-light">Jejak audit lengkap dan kawalan akses untuk jawatankuasa.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex align-items-start gap-4">
                                    ...
                                    <div>
                                        <h5 class="fw-bold mb-1 text-gold">TERBUKA</h5>
                                        <p class="mb-0 fs-7 text-light">Direka untuk amanah rakyat dan keyakinan komuniti.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="devices-showcase-container d-flex align-items-end justify-content-center gap-4 mt-auto w-100 pb-2">
                        ...
                        <div class="device-tall shadow-lg">
                            ...
                            <div class="device-tall-screen">
                                <p class="mb-3 text-white fw-bold fs-6">Terima Kasih<br>atas sumbangan<br>anda</p>
                                <p class="text-gold fs-7 mb-4">Terima kasih kerana berwakaf</p>
                        ...
                        <div class="device-small shadow-lg">
                            ...
                            <div class="device-small-screen">
                                ...
                                <p class="fs-8 text-muted mb-0" style="font-size:0.75rem;">Terima kasih atas sumbangan anda</p>
                            </div>
                        ...
                        <div class="gold-circle-badge shadow-lg">
                            ...
                            <span class="fw-bold text-primary-dark" style="font-size:0.75rem;line-height:1.1;">TEKNOLOGI<br>AMANAH<br>TRANSPARENSI</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section-padding section-pattern" id="why">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="section-title">Kenapa DanaHibah?</h2>
                <p class="section-subtitle">Direka untuk meningkatkan keyakinan komuniti, memudahkan pengurusan jawatankuasa, dan melindungi setiap sumbangan dari peranti ke awan.</p>
            </div>
            <div class="row g-4">
                <div class="col-md-6 col-lg-3">
                    <div class="elite-card">
                        ...
                        <h3>Selamat</h3>
                        <p>Perkakasan tahan gangguan yang dilengkapi dengan pemantauan masa nyata dan amaran keselamatan segera.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="elite-card">
                        ...
                        <h3>Telus</h3>
                        <p>Laporan kutipan yang jelas dan boleh dipantau pada bila-bila masa dari mana-mana peranti.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="elite-card">
                        ...
                        <h3>Akauntabel</h3>
                        <p>Jejak audit yang lengkap, kelulusan berperingkat, dan kawalan akses mengikut peranan untuk jawatankuasa.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="elite-card">
                        ...
                        <h3>Terbuka</h3>
                        <p>Direka khusus untuk menjaga amanah rakyat dan memperkukuh keyakinan komuniti terhadap institusi.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-padding bg-white" id="how">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="section-title">Bagaimana DanaHibah™ Berfungsi</h2>
                <p class="section-subtitle">Kitaran hayat derma dan tadbir urus yang lancar dan automatik sepenuhnya.</p>
            </div>
            <div class="steps-flex-container">
                <div class="step-card-wrapper">
                    <div class="step-card">
                        ...
                        <h4>Penderma</h4>
                        <p>Penderma membuat derma tunai atau imbas kod QR.</p>
                    </div>
                </div>
                ...
                <div class="step-card-wrapper">
                    <div class="step-card">
                        ...
                        <h4>Perkakasan Pintar</h4>
                        <p>Peranti DanaHibah merekod kutipan dan mencetak resit (jika perlu).</p>
                    </div>
                </div>
                <div class="step-arrow-wrapper">
                    <i class="bi bi-arrow-right"></i>
                ...
                <div class="step-card-wrapper">
                    <div class="step-card">
                        ...
                        <h4>Sambungan Selamat</h4>
                        <p>Data disulitkan dan dihantar ke pelayan awan dengan selamat.</p>
                    </div>
                </div>
                <div class="step-arrow-wrapper">
                    <i class="bi bi-arrow-right"></i>
                ...
                <div class="step-card-wrapper">
                    <div class="step-card">
                        ...
                        <p>Data disimpan dan dianalisis secara masa nyata di platform awan.</p>
                    </div>
                </div>
                <div class="step-arrow-wrapper">
                    <i class="bi bi-arrow-right"></i>
                ...
                <div class="step-card-wrapper">
                    <div class="step-card">
                        ...
                        <h4>Pengurusan & Laporan</h4>
                        <p>Jawatankuasa melihat papan pemuka dan memuat turun laporan lengkap.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-padding section-pattern" id="solutions">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="section-title">Satu Sistem, Semua Dihubungkan</h2>
                <p class="section-subtitle">Menggabungkan perkakasan derma IoT berteknologi tinggi dengan platform tadbir urus awan bertaraf enterprise.</p>
            </div>
            <div class="row g-5">
                <!-- Hardware Box -->
                <div class="col-lg-6">
                    <div class="deep-dive-box h-100">
                        <div class="deep-dive-header">
                            <h3>Perkakasan Derma Pintar</h3>
                            <p>Direka untuk keselamatan, kebolehpercayaan, dan sambungan masa nyata</p>
                        </div>
                        <div class="feature-list">
                            <div class="feature-list-item">
                                <div class="feature-list-icon"><i class="bi bi-cash-stack"></i></div>
                                <div class="feature-list-content">
                                    <h5>Penerima Tunai & Pengira</h5>
                                    <p>Pengiraan tepat dengan pengesanan wang palsu canggih terbina dalam.</p>
                                </div>
                            </div>
                            <div class="feature-list-item">
                                <div class="feature-list-icon"><i class="bi bi-qr-code"></i></div>
                                <div class="feature-list-content">
                                    <h5>Bayaran Kod QR</h5>
                                    <p>Menyokong pelbagai e-dompet utama, aplikasi perbankan, dan DuitNow QR.</p>
                                </div>
                            </div>
                            <div class="feature-list-item">
                                <div class="feature-list-icon"><i class="bi bi-broadcast"></i></div>
                                <div class="feature-list-content">
                                    <h5>Sambungan Masa Nyata</h5>
                                    <p>Sambungan IoT 4G/5G untuk penghantaran data serta-merta ke awan.</p>
                                </div>
                            </div>
                            <div class="feature-list-item">
                                <div class="feature-list-icon"><i class="bi bi-exclamation-triangle"></i></div>
                                <div class="feature-list-content">
                                    <h5>Amaran Gangguan & Sokongan CCTV</h5>
                                    <p>Amaran serta-merta untuk akses tanpa kebenaran, menyokong integrasi CCTV.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="deep-dive-box h-100">
                        <div class="deep-dive-header" style="background:var(--primary-dark);">
                            ...
                            <p>Platform berpusat untuk pemantauan, analisis, dan kawalan menyeluruh</p>
                        </div>
                        <div class="feature-list">
                            <div class="feature-list-item">
                                <div class="feature-list-icon"><i class="bi bi-speedometer2"></i></div>
                                <div class="feature-list-content">
                                    <h5>Papan Pemuka Langsung</h5>
                                    <p>Pantau kutipan secara langsung dan status peranti dari mana-mana, bila-bila masa.</p>
                                </div>
                            </div>
                            <div class="feature-list-item">
                                <div class="feature-list-icon"><i class="bi bi-journal-check"></i></div>
                                <div class="feature-list-content">
                                    <h5>Laporan & Audit Lengkap</h5>
                                    <p>Hasilkan laporan harian, mingguan, bulanan dengan mudah berserta jejak audit.</p>
                                </div>
                            </div>
                            <div class="feature-list-item">
                                <div class="feature-list-icon"><i class="bi bi-diagram-3"></i></div>
                                <div class="feature-list-content">
                                    <h5>Pengurusan Pelbagai Lokasi</h5>
                                    <p>Urus banyak cawangan masjid dan surau dengan mudah dalam satu platform.</p>
                                </div>
                            </div>
                            <div class="feature-list-item">
                                <div class="feature-list-icon"><i class="bi bi-cpu"></i></div>
                                <div class="feature-list-content">
                                    <h5>Pengesanan Anomali AI</h5>
                                    <p>Amaran pintar untuk aktiviti luar biasa atau ketidakteraturan dalam kutipan.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="section-padding bg-white" id="features">
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <h2 class="section-title mb-4">Ciri-Ciri Utama</h2>
                    <div class="row g-4 mt-2">
                        <div class="col-sm-6">
                            <div class="p-4 border rounded-4 bg-light h-100 shadow-sm" style="border-color:rgba(201,168,76,0.3)!important;">
                                ...
                                <h5 class="fw-bold text-dark mb-2 fs-5">Terima Tunai & Bayaran QR</h5>
                                <p class="text-muted fs-7 mb-0">Sokong pelbagai e-dompet dan perbankan dengan selamat.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-4 border rounded-4 bg-light h-100 shadow-sm" style="border-color:rgba(201,168,76,0.3)!important;">
                                <i class="bi bi-display text-gold fs-2 mb-3 d-block"></i>
                                <h5 class="fw-bold text-dark mb-2 fs-5">Pantauan Masa Nyata</h5>
                                <p class="text-muted fs-7 mb-0">Lihat kutipan secara langsung dari mana-mana peranti.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-4 border rounded-4 bg-light h-100 shadow-sm" style="border-color:rgba(201,168,76,0.3)!important;">
                                <i class="bi bi-file-bar-graph text-gold fs-2 mb-3 d-block"></i>
                                <h5 class="fw-bold text-dark mb-2 fs-5">Laporan Automatik</h5>
                                <p class="text-muted fs-7 mb-0">Laporan harian, mingguan & bulanan dengan satu klik.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-4 border rounded-4 bg-light h-100 shadow-sm" style="border-color:rgba(201,168,76,0.3)!important;">
                                <i class="bi bi-shield-check text-gold fs-2 mb-3 d-block"></i>
                                <h5 class="fw-bold text-dark mb-2 fs-5">Selamat & Dipercayai</h5>
                                <p class="text-muted fs-7 mb-0">Perlindungan data bertaraf enterprise yang kukuh.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <h2 class="section-title mb-4">Kebaikan Untuk Anda</h2>
                    <div class="accordion mt-4" id="benefitsAccordion">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    <i class="bi bi-building me-3 text-gold"></i> Untuk Masjid & Surau
                                </button>
                            </h2>
                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#benefitsAccordion">
                                <div class="accordion-body">
                                    <ul class="mb-0 ps-3">
                                        <li class="mb-2"><strong>Ketelusan yang lebih baik:</strong> Membina keyakinan jemaah dan masyarakat melalui rekod yang jelas.</li>
                                        <li class="mb-2"><strong>Laporan lebih mudah:</strong> Menjimatkan masa pengurusan dengan sistem laporan automatik.</li>
                                        <li class="mb-2"><strong>Kurang kerja manual:</strong> Mengurangkan risiko kesilapan manusia dalam pengiraan dan perekodan.</li>
                                        <li><strong>Keyakinan jemaah meningkat:</strong> Membuktikan integriti tinggi dalam pengurusan kewangan masjid.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                    <i class="bi bi-people me-3 text-gold"></i> Untuk Jawatankuasa
                                </button>
                            </h2>
                            <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#benefitsAccordion">
                                <div class="accordion-body">
                                    <ul class="mb-0 ps-3">
                                        <li class="mb-2"><strong>Pantauan masa nyata:</strong> Memantau jumlah kutipan dan status peranti secara langsung.</li>
                                        <li class="mb-2"><strong>Jejak audit selamat:</strong> Setiap transaksi direkod dengan terperinci dan boleh dijejak.</li>
                                        <li class="mb-2"><strong>Rekonsiliasi lebih cepat:</strong> Memudahkan proses semakan kemasukan wang ke dalam bank.</li>
                                        <li><strong>Akses ikut peranan:</strong> Kawalan keselamatan yang membezakan bidang kuasa pentadbir.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    <i class="bi bi-heart me-3 text-gold"></i> Untuk Penderma & Komuniti
                                </button>
                            </h2>
                            <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#benefitsAccordion">
                                <div class="accordion-body">
                                    <ul class="mb-0 ps-3">
                                        <li class="mb-2"><strong>Lebih percaya dan yakin:</strong> Ketenangan minda mengetahui sumbangan diurus dengan selamat dan telus.</li>
                                        <li class="mb-2"><strong>Akauntabiliti jelas:</strong> Resit digital serta-merta dan pengurusan dana yang teratur.</li>
                                        <li><strong>Pengalaman derma moden:</strong> Kaedah bayaran yang pantas, mudah dan mesra pengguna melalui kod QR atau tunai.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <section class="section-padding section-pattern">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="section-title">Mudah Digunakan · Mampu Milik · Dihasilkan di Malaysia</h2>
                <p class="section-subtitle">Dibangunkan dengan bangga untuk menyokong institusi keagamaan tempatan dan keperluan komuniti di seluruh Malaysia.</p>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-2-5 col-xl-2">
                    <div class="pillar-card">
                        ...
                        <p>Sesuai untuk semua peringkat umur.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-2-5 col-xl-2">
                    <div class="pillar-card">
                        ...
                        <h5>Berpatutan</h5>
                        <p>Kos efektif dan nilai pelaburan terbaik.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-2-5 col-xl-2">
                    <div class="pillar-card">
                        <div class="pillar-icon"><i class="bi bi-shield-check"></i></div>
                        <h5>Boleh Dipercayai</h5>
                        <p>Perkakasan berkualiti dan sistem stabil.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-2-5 col-xl-2">
                    <div class="pillar-card">
                        <div class="pillar-icon"><i class="bi bi-headset"></i></div>
                        <h5>Sokongan Tempatan</h5>
                        <p>Pasukan sokongan cepat dan mesra.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-2-5 col-xl-2">
                    <div class="pillar-card">
                        <div class="pillar-icon"><i class="bi bi-flag"></i></div>
                        <h5>Dihasilkan di Malaysia</h5>
                        <p>Sokongan tempatan untuk institusi tempatan.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="cta-section">
                <div class="row align-items-center justify-content-between g-4 position-relative z-2">
                    <div class="col-lg-8">
                        <h2 class="fw-bold mb-3 text-white fs-1">"Bersama teknologi, kita jaga amanah. Bersama DanaHibah™, kita bina keyakinan."</h2>
                        <p class="fs-5 text-light mb-0">Sertai masjid dan surau terkemuka di seluruh Malaysia dalam memodenkan kutipan derma dan memelihara amanah jemaah.</p>
                    </div>
                    <div class="col-lg-4 text-lg-end">
                        <a href="login.php" class="btn btn-login py-3 px-5 fs-5">Mula Sekarang</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="footer" id="contact">
        <div class="container">
            <div class="row g-5 mb-5">
                <div class="col-lg-5">
                    <a href="home_ms.php" class="footer-brand d-flex align-items-center gap-2 mb-3">
                        <img src="assets/images/logo.png" alt="DanaHibah Logo" style="width: 48px; height: 48px; object-fit: contain;">
                        <span>DanaHibah™</span>
                    </a>
                    <p class="mb-4 pe-lg-5">Sistem Tadbir Urus & Kutipan Derma untuk Masjid & Surau. Membantu institusi mengurus kutipan derma dengan lebih telus, selamat dan mudah melalui gabungan perkakasan pintar dan platform digital bersepadu.</p>
                ...
                <div class="col-lg-3">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="#why">Kenapa DanaHibah</a></li>
                        <li><a href="#how">Cara Berfungsi</a></li>
                        <li><a href="#solutions">Penyelesaian Kami</a></li>
                        <li><a href="#features">Ciri & Kebaikan</a></li>
                        <li><a href="login.php">Log Masuk Sistem</a></li>
                    </ul>
                </div>
                <div class="col-lg-4">
                    ...
                    <div class="mt-4 p-3 bg-light rounded-4 border text-center" style="max-width:220px;border-color:rgba(201,168,76,0.3)!important;">
                        ...
                        <span class="fs-7 fw-bold text-dark">IMBAS DI SINI KETAHUI LEBIH LANJUT TENTANG DANAHIBAH™</span>
                    </div>
                </div>
            </div>
            <hr class="my-4 border-secondary-subtle">
            <div class="d-flex flex-wrap justify-content-between align-items-center fs-7 text-muted">
                <div>&copy; <?= date('Y') ?> DanaHibah™. Hak cipta terpelihara. Selamat · Telus · Amanah.</div>
                <div class="d-flex gap-4 mt-2 mt-md-0">
                    <a href="#" class="text-muted">Dasar Privasi</a>
                    <a href="#" class="text-muted">Terma Perkhidmatan</a>
                    <a href="#" class="text-muted">Keselamatan</a>
                </div>
            </div>
        </div>
    </footer>
